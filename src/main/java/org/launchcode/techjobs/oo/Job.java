...
public class Job {
    ...
    //  the 'id' field.
    // Added a constructor that assigns an id
    public Job() {
        id = nextId;
        nextId++;
    }
// Constructor calls above constructor to assign id, and initializes the other 5 fields in Job, an empty this calls the default constructor
